...
router.get('/:pglo:id', [validarJWT_1.default, validar_campos_1.default], prod_global_1.getProdGlobal);
router.post('/', [validarJWT_1.default, validar_campos_1.default], prod_global_1.postProdGlobal);
router.put('/:pglo:id', [validarJWT_1.default, validar_campos_1.default], prod_global_1.putProdGlobal);
