...
exports.deleteParto = exports.putParto = exports.postParto = exports.getPartoPorAnimal = exports.getParto = exports.getPartos = void 0;
...
const getPartoPorAnimal = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { ani_id } = req.params;
    const partos = yield tbl_parto_1.default.findAll({
        where: {
            ani_id,
            par_estado: true
        }
...
exports.getPartoPorAnimal = getPartoPorAnimal;
